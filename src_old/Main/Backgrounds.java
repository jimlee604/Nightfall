...
public class Backgrounds {
    private static ImageIcon _innImage = new ImageIcon("images/InnBG.png");
    private static ImageIcon _shopImage = new ImageIcon("images/ShopBG.png");
    private static ImageIcon _forestImage = new ImageIcon("images/ForestBG.png");
    private static ImageIcon _itemsImage = new ImageIcon("images/ItemsBG.png");
    private static ImageIcon _unequipImage = new ImageIcon("images/UnequipBG.png");
    ...
    private static Player _player = GameData.getPlayer();
...
//        _size = new Dimension(525, 141);
    ...
    public static void displayShop() {
        try {
            Player.addItem(new Consumable("potion"));
    ...
    public static void displayForest() {
        //delete
        try {
            Player.addItem(Equipment.create("WoodenSword"));
    ...
    public static void displayItems() {
        ...
        int prefheight = (height - top) / Player.itemCap();
...
//            button.addActionListener(new Events.doItem(item, _info));
    ...
    public static void updateBottomRight() {
        ...
        c.gridy = 0;
        c.gridwidth = 4;
        JLabel label = new JLabel(Functions.spaces(Player.hpPercent() / 2));
        stats.add(label, c);
        label.setForeground(Color.RED);
        c.gridy = 1;
        label = new JLabel(Functions.spaces(Player.mpPercent() / 2));
        stats.add(label, c);
